<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"C:\wamp\www\TPC\tp5\public/../application/reslog\view\register\register.html";i:1508767351;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<script type="text/javascript">
    ...
    {
        $.post("<?php echo url('reslog/register/yzm'); ?>", {yzm:$('input[name=yzm]').val()}, function(data){
            if(data)
            {   
                alert('用户名已经存在');
                $('input[name=yzm]').val(''); 
